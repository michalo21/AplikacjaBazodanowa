...
public class ProjektPO2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        addProduct.setOnAction((ActionEvent event)->{
           ...
           product.setZdjecie_produktu(insertPhoto());
       ...
       private void wklejanieKategorii(){
            idTableCat.setCellValueFactory(new PropertyValueFactory<>("id_kategorii"));
            nameTableCat.setCellValueFactory(new PropertyValueFactory<>("nazwa_kategorii"));
            tabCat.setItems(FXCollections.observableList(catDAO.getAll()));   
        }
       
       private void wklejaniePodkategorii(){
            idTableUnderCat.setCellValueFactory(new PropertyValueFactory<>("id_podkategorii"));
        ...
        private void wklejanieProducenta(){
            idTableProducent.setCellValueFactory(new PropertyValueFactory<>("id_producenta"));
         ...
         //funkcja pmocnicza by pobrac bity pliku ktore potem sie przydadza do umieszczenia w bazie danych
         public byte[] insertPhoto(){
            File file = new File(textChosenFile.getText());
